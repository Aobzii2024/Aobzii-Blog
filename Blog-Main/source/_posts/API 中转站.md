...
3. https://longcat.chat/platform
	- 站点介绍：美团模型、每日免费额度大、性能可观
...
1. [芝麻](https://crs.happycode.online)
	- 站点介绍：稳定还是稳定、价格可以
	- 模型列表：Claude、GPT、Kimi、GLM、Gemini ..
	- API共享：(想啥呢？🤣🫵)
![](https://cdn.jsdelivr.net/gh/Aobzii2024/Aobzii-Blog@main/images/Pasted%20image%2020260423165310.png)

2. [Routin](https://routin.ai)
	- 站点介绍：稳定、模型多但是部分价格偏高
	- 模型列表：Claude、GPT、Kimi、GLM、Gemini ..
	- API共享：无
![](https://cdn.jsdelivr.net/gh/Aobzii2024/Aobzii-Blog@main/images/Pasted%20image%2020260423165922.png)

3. [LiuNew API](http://api.221.qzz.io)
	- 站点介绍：与芝麻类似，但是主要提供GPT、Codex
	- 模型列表：GPT、Codex最新系列
	- API共享：无
